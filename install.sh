...
# erpnext-code installer
# Usage: curl -fsSL https://raw.githubusercontent.com/balhadj47/erpnext-code/main/install.sh | bash
...
REPO="https://github.com/balhadj47/erpnext-code.git"
INSTALL_DIR="$HOME/erpnext-code"
...
header() {
 ...
 |  ____|  __ \|  __ \             | |       / ____|        | |
 | |__  | |__) | |__) |_ __  _ __ | |_ ___ | |     ___   __| | ___
 |  __| |  _  /|  ___/| '_ \| '_ \| __/ _ \| |    / _ \ / _` |/ _ \
 | |____| | \ \| |    | | | | |_) | || (_) | |___| (_) | (_| |  __/
 |______|_|  \_\_|    |_| |_| .__/ \__\___/ \_____\___/ \__,_|\___|
                            | |
                            |_|
ART
  printf "${RESET}"
  printf "${DIM}  ERPNext v16 Specialist — AI coding agent for Frappe Framework${RESET}\n"
  echo ""
}
...
build_binary() {
  info "Building erpnext-code (all experimental features enabled)..."
  cd "$INSTALL_DIR"
...
link_binary() {
  ...
  ln -sf "$INSTALL_DIR/cli-dev" "$link_dir/erpnext-code"
  ok "Symlinked: $link_dir/erpnext-code"
...
printf "    ${CYAN}erpnext-code${RESET}                        # interactive REPL\n"
printf "    ${CYAN}erpnext-code -p \"your prompt\"${RESET}        # one-shot mode\n"
echo ""
printf "  ${BOLD}Set your API key:${RESET}\n"
printf "    ${CYAN}export DEEPSEEK_API_KEY=\"sk-...\"${RESET}\n"
printf "    ${CYAN}export ANTHROPIC_API_KEY=\"sk-ant-...\"${RESET}\n"
echo ""
printf "  ${DIM}Source: $INSTALL_DIR${RESET}\n"
printf "  ${DIM}Binary: $INSTALL_DIR/cli-dev${RESET}\n"
printf "  ${DIM}Link:   ~/.local/bin/erpnext-code${RESET}\n"
echo ""
